CREATE OR REPLACE PACKAGE "CNL_SYS"."CNL_CTO_PCK" 
is
...
-- Procedure to fetch the authenticate key from Centiro web service
...
-- add record for print speed monitoring
...
-- Fetch orders to add as shipment to CTO.
